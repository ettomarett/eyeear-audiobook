    ...
    <div className="extraction-preview">
      ...
      {isOverLimit && (
        <div className="warning-box">
          <strong>⚠️ Warning:</strong> This book exceeds the 1 million character limit for long audio synthesis.
      ...
      {!isOverLimit && characterCount > 500000 && (
        <div className="info-box">
          <strong>ℹ️ Note:</strong> Large books may take several minutes to process.
        </div>
      )}
